...
| 5a | Les envois sans prestataire : table `envois`, modèles, PDF, paquet pour la messagerie du gérant | à écrire | — |
| 5b | Maileva (recommandé hybride) | à écrire | attend le type de contrat |
| 5c | AR24 (recommandé électronique) | à écrire | — |
| 5d | Signature électronique de l'échéancier | à écrire | attend le choix du prestataire |
| 6 | L'agent dans le dossier | à écrire | — |
