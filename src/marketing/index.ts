 ...
 *
 * Une section par fichier. C'est la seule discipline qui tient sur une page
 * commerciale : elle change souvent, elle change par morceaux, et un fichier
 * unique de mille lignes devient en trois semaines un endroit où personne
