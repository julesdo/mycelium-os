		...
		<PageEcran
			entete={{
				...
				/*
				  ...
				  l'accueil, les procédures ou le volet de son débiteur, et n'avait
				  aucun retour. Elle revient là d'où l'on vient par l'historique ;
				  ouverte par un lien direct, elle rouvre son débiteur, sous le nom de
				  la liste. Son titre porte le débiteur : la page s'identifie seule.
				*/
				retour: {
					vers: '/app/debiteurs',
